...
import domain.dao.factory.ProdutoQuantidadeFactory;
import domain.dao.factory.VendaFactory;
...
//		return venda;
    ...
    private StringBuilder sqlBaseSelect() {
        ...
        sb.append("C.ID AS ID_CLIENTE, C.NOME, C.CPF, C.TELEFONE, C.ENDERECO, C.NUMERO, C.CIDADE, C.ESTADO, C.DATA_CADASTRO ");
